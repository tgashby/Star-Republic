...
public:
   /*
    * EnemyShip construct, takes 2 strings representing the object file path and the texture file path respectively, a Modules pointer, and a player reference.
   ...
   /*
    * shouldFire slows down the enemy's rate of fire so that the player isn't dodging a constant stream of bullets
    */
   bool shouldFire();
   
   /*
    * getLeftCannonPos returns the position of the left cannon, used for where to initiate bullets
    */
   Vector3<float> getLeftCannonPos();
   
   /*
    * getRightCannonPos returns the position of the right cannon, used for where to initiate bullets
    */
